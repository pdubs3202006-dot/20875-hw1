...
def problem1(year):
    """
    When given a year, determine if the year is even or odd, but if it is a leap year, that takes precedence over even.
...
def problem2(given_number):
    """
    When given any number, return a list of all values that are pentagonal numbers that are less than or equal to the given_number
    ...
    while (x = 0):
        ...
        if given_number > z:
            ...
            list1.append(z) #adds it to the list
...
if __name__ == '__main__' :
    ...
    print("\nProblem 2:")
    print("Problem 2 answer correct?",problem2(8)==[1, 5], "      Student answer was:", problem2(8))
